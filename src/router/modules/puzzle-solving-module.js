 ...
 * @LastEditors: Fred
 * @LastEditTime: 2021-03-11 14:27:01
 */
  ...
  children: [
    {
      ...
      component: () => import(/* webpackChunkName: "puzzle-solving-module" */ '@/views/puzzle-solving-module'),
      meta: {
        crmuns: [{ item: '解惑模块' }],
      },
    }, {
      ...
      component: () => import(/* webpackChunkName: "puzzle-solving-detail" */ '@/views/puzzle-solving-module/detail'),
      meta: {
