...
<script>
  ...
  export default {
    ...
    data() {
      const ADMIN = (rule, value, callback) => {
        if (!value) {
      ...
      return {
        ...
        loginRules: {
          username: [{ required: true, trigger: "blur", validator: ADMIN }],
          password: [{ required: true, trigger: "blur", validator: admin }],
        },
