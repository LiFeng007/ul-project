 ...
 * @LastEditors: Fred
 * @LastEditTime: 2021-03-15 17:23:12
-->
<template>
  <div class="ul-project-management">
    ...
    <div class="ul-main-com">
      ...
      <el-table ref="filterTable" :data="masterData" height="500" style="width: 100%">
        ...
        <el-table-column prop="projectIntegral" label="项目积分" min-width="120" sortable>
        </el-table-column>

        <el-table-column prop="uploader" label="上传人" min-width="100">
        </el-table-column>

        <el-table-column prop="uploadTime" label="上传时间" show-overflow-tooltip min-width="180" sortable>
        </el-table-column>

        <el-table-column prop="toBeComplete" label="待完成" min-width="120" sortable>
        </el-table-column>

        <el-table-column prop="toExamineing" label="审核中" min-width="120" sortable>
        </el-table-column>

        <el-table-column prop="completed" label="已完成" min-width="120" sortable>
        </el-table-column>
    ...
    methods: {
      ...
      del: function (status , row) {
        this.confirmMssage = [
          ...
          `项目${status ? '上线后将可以' : '下线后将不可以'}操作，请仔细核对后操作。`
        ]
        this.delDate = row;
      ...
      upload: function (file) {
        ...
        this.uploadTips = {
          ...
          tableHeader: [
            ...
            { col: "项目描述", prop: "projectDescribe" , minWidth:'200' , isTips:true},
            { col: "项目积分", prop: "projectIntegral" },
          ],
          tableData: [
            { projectName: "项目A", projectDescribe: "项目描述项目秒项目描述项目描述A", projectIntegral: "200" },
            { projectName: "项目B", projectDescribe: "项目描述项目秒项目描述项目描述B", projectIntegral: "20" },
            { projectName: "项目C", projectDescribe: "项目描述项目秒项目描述项目描述C", projectIntegral: "21" },
            { projectName: "项目D", projectDescribe: "项目描述项目秒项目描述项目描述D", projectIntegral: "1" },
            { projectName: "项目E", projectDescribe: "项目描述项目秒项目描述项目描述E", projectIntegral: "100" },
          ],
        };
      },
    },
